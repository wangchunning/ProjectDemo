...
|--------------------------------------------------------------------------
|
| Next we will load the event handlers file for the application. This gives us
| a nice separate location to keep track of our events.
|
*/
...
/*
  ...
  | Load Custom Helpers
  |--------------------------------------------------------------------------
  | Put your helper file to directory `app/helpers/`
*/
