...
trait HasRole
{
    ...
    public function ability($permissions, $options=array() ) {
        ...
        if(($options['validate_all'] && !(in_array(false,$checkedPermissions))) ||
            (!$options['validate_all'] && (in_array(true,$checkedPermissions)))) {
            $validateAll = true;
        } else {
            $validateAll = false;
        }
        ...
        if($options['return_type'] == 'boolean') {
            ...
            return array('permissions' => $checkedPermissions);
        } else {
            return array($validateAll, array('permissions' => $checkedPermissions));
        }
