...
@include('breadcrumb')
    ...
    <div class="container flat-panel">
        <div class="all-radius white-box-body">
            ...
            {{ Form::open(array('url' => url('/profile/change-withdraw-password'), 'role' => 'form', 'id' => 'frm')) }}
                <h4><i class="fa fa-key"></i>    修改交易密码</h4>
                <hr class="mt0">
                ...
                <hr class="mt20 mb30">                
                <button type="submit" class="button button-rounded button-flat-primary">更新交易密码</button>                       
            {{ Form::close() }}
        </div>
    </div>
@stop
