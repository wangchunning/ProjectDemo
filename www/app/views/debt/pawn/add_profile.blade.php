...
<div class="container">
	<div class="dashboard-body">
		...
		<div class="flat-panel">
            ...
            {{ Form::open(array('url' => '/debt/pawn-add-profile', 'role' => 'form', 'id' => 'frm')) }}

								
			<div class="form-group row mt30">
				<label for="amount" class="col-sm-2 text-right mt5">公司名称</label>
				<div class="col-sm-4 pr0">
					<input type="text" name="company_name" id="company_name" class="form-control" value="{{ Input::old('company_name') }}"
	        ...
	        <div class="form-group row">
				...
				<div class="col-sm-3">
					{{ Form::select('industry', UserProfile::company_category_arr(), '', array('class' => 'form-control')) }}
				</div>
			</div>	
			<div class="form-group row">
				<label for="amount" class="col-sm-2 text-right mt5">资金用途</label>
				<div class="col-sm-4 pr0">
					<input type="text" name="purpose" id="purpose" class="form-control" value="{{ Input::old('purpose') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row">
				...
				<div class="col-sm-4 pr0">
					<input type="text" name="repayment_from" id="repayment_from" class="form-control" value="{{ Input::old('repayment_from') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row">
				...
				<div class="col-sm-2 pr0">
					<input type="text" name="state" id="state" class="form-control" value="{{ Input::old('state') }}"
						placeholder="省"
						data-bv-notempty="true"
				...
				<div class="col-sm-2 pr0">
					<input type="text" name="city" id="city" class="form-control" value="{{ Input::old('city') }}"
						placeholder="市"
						data-bv-notempty="true"
			...
			<div class="form-group row">
				...
				<div class="col-sm-3 pr0">
					<input type="text" name="register_date" id="register_date" class="form-control datepicker" value="{{ Input::old('register_date') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row">
				...
				<div class="col-sm-3 pr0">
					<input type="text" name="register_capital" id="register_capital" class="form-control" value="{{ Input::old('register_capital') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row mt20">
				...
				<div class="col-sm-3 pr0">
					<input type="text" name="property_value" id="property_value" class="form-control" value="{{ Input::old('property_value') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row mt20">
				...
				<div class="col-sm-3 pr0">
					<input type="text" name="last_year_income" id="last_year_income" class="form-control" value="{{ Input::old('last_year_income') }}"
						data-bv-notempty="true"
			...
			<div class="form-group row mt30">
				...
				<div class="col-sm-4 pr0">
					<input type="text" name="pawn" id="pawn" class="form-control" value="{{ Input::old('pawn') }}"
						data-bv-notempty="true"
			...
			<div class="ml20 mt30 row">
				<span class="col-sm-4">
					<button type="submit" class="button button-rounded button-flat-primary">下一步</button> 或 <a href="javascript:;" onclick="javascript:history.back(-1);">上一步</a>       
				</span>	                                   
			</div>
