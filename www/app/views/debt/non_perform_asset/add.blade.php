...
<div class="container">
    ...
    {{ Form::open(array('url' => 'debt/add-non-perform-asset', 'role' => 'form', 'id' => 'addDebtFrm')) }}
        
        <h4 class="mt40">注册不良资产</h4>
        ...
        <div class="form-group row ">
            <div class="col-sm-3">
                <label for="expect_price">挂牌价格</label>
            ...
            <div class="col-sm-3">
                <label for="debt_principal">债权本金</label>
                <input type="text" name="debt_principal" id="debt_principal" placeholder="" value="{{ Input::old('debt_principal') }}"
                        class="form-control validate[required,custom[number]]">
            </div>            
        </div>
