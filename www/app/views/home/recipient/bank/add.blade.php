<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
             <h4 class="modal-title">添加银行账号信息</h4>
        </div>
    {{ Form::open(array('url' => 'recipient/add-bank', 'role' => 'form', 'id' => 'recipientFrm') )}}                    
        <div class="modal-body">
            ...
            <div class="text-center action-panel">
                ...
                <button type="submit" class="btn btn-primary btn-lg">添加</button> 或, <a href="javascript:;" data-dismiss="modal" aria-hidden="true">取消</a>                                            
            </div>                        
        </div>
    {{ Form::close() }}
    </div>
...
<script>
$(function(){
    adjustBankField('{{ $recipient->transfer_country }}');
    ...
    $("#recipientFrm").validationEngine({
        ...
        ajaxFormValidationURL : '/recipient/add-bank',
