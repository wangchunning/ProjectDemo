...
@section('content')
    <tr><td>
        <p style="font-family: 'Helvetica Neue'; font-size: 26px; font-weight: bold; color: #363636; margin: 1em 0;">
            尊敬的用户！
        </p>
    </td></tr>
    <tr><td width='435'>
        <p style='font-family: Helvetica; font-size: 14px; color: #363636; line-height: 22px; margin-bottom: 1.3em'>
            <strong> {{ $inviter }} </strong> 邀请您成为 <strong>{{ $company }}</strong> 的成员，以方便管理其在 Anying 的账户。
        </p>
        <p style='font-family: Helvetica; font-size: 14px; color: #363636; line-height: 22px; margin-bottom: 1.3em'>
            如果您接受邀请，请点击下面的链接：
        </p>
